...
Companion v0.2.1 bundle preserves the historical v0.1 companion while providing
...
def main() -> None:
    ...
    if spec_document.get("companion_version") != "v0.2.1":
        raise SystemExit("public v0.2.1 figure specification must declare Companion v0.2.1")
    ...
    print(f"PYSTATSV1_BOOK1_V021_PUBLIC_FIGURES_OK figures={len(rows)} manifest={args.manifest}")
