...
- :doc:`track_d_chapter_index` — a chapter map (D00–D23): what to run + what to look at
...
- :doc:`track_d_assignments` — **student labs + rubric** (gradeable artifacts + short answers)
